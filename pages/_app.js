...
export default function App({ Component, pageProps }) {
  ...
  const isAdminRoute = router.pathname.startsWith("/admin/") || router.pathname === "/admin";
    ...
    <>
      ...
      <CartProvider>
        <main className={`${poppins.variable}`}>
          ...
          {/* Scripts outside CartProvider — they don't need cart context */}
