        ...
        <>
            {isOpen && (
                <section className="btm-form dark-form-bg flex-col md:flex-row fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center w-auto">
                    <div className="home-popup-modal-wrapper-new relative my-20">
                        <Image
                            className="text-center form-off-badge-new"
                            src={"/images/form-badge.png"}
                            width={130}
                            height={130}
                            loading="lazy"
                        ></Image>
                        <div className="form-mid-wrap bg-gray-200 connect-form-border-new mb-12 relative transparent-connect-form-border-new">
                            <div className="flex flex-col md:flex-row items-center justify-start md:gap-10 relative mx-0 md:mx-10 px-3">
                                ...
                                <form className="popup-form-wrapper-new" onSubmit={handleSubmit}>
                                    ...
                                    <div className="py-5">
                                        ...
                                        <div className="relative mb-3">
                                            <select name="budget" value={budget} onChange={handleChange} className="text-grey-400 pl-4 pr-4 py-2 border rounded-lg w-full home-connect-form-input font-poppins">
