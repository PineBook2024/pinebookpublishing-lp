            ...
            <section className="brand-cta-section max-w-screen-xl mx-auto px-6 md:px-20 my-20 relative py-24">
                <div className="flex items-center flex-col md:flex-row">
                    <div className="basis-1/3 brand-cta-vector">
                        <Image src={"/brand-img/cta-book.webp"} width={500} height={200} className="brand-cta-book"></Image>
                    </div>
                    <div className="basis-1/2 md:ml-20">
                        <h2 className="text-white font-majallab text-5xl md:text-6xl">{props.title}</h2>
