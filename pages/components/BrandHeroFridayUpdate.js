                                    ...
                                    <div className="col-span-2 w-full relative">
                                        <form className="flex flex-col gap-3 justify-start items-start" onSubmit={handleSubmit}>
                                            ...
                                            <div class="flex items-start mb-5">
                                                ...
                                                <label for="remember" class="ms-2 text-sm font-medium text-white dark:text-gray-300">By checking this box, I consent to received text messages related to Ghostwriting, Editing, Designing, Publishing and Marketing services from Pine Book Writing and Publishing. you can reply "STOP" at any time to opt-out. Message and data rates may apply. Message Frequency may vary, text Help to <Link href="tel:(866) 841-7469" className="text-blue-400">(866) 841-7469</Link> for assistance. For more information, please refer to our <Link href="privacy-policy" className="text-blue-400" target="_blank">PRIVACY POLICY</Link> and SMS <Link href="terms-and-conditions" className="text-blue-400" target="_blank"> TERMS and CONDITIONS </Link> on our website</label>
                                                </div>
                                            {showSuccess && (
