        ...
        <>
            <div className="nav-top-bar text-center py-2 ">
                ...
                <div className="max-w-screen-xl flex justify-center md:justify-end gap-6 mx-auto items-center">
                    <Link
                        href="tel:8668417469"
                        className="text-white text-xl hover:text-white font-majallab flex justify-center items-center"
                    >
                    ...
                    <Link
                        ...
                        className="text-white hover:text-white font-majallab text-xl md:text-xl flex justify-center md:justify-start items-center"
                    >
