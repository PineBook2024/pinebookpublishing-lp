                ...
                <div className="max-w-screen-xl">
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-majallab text-3xl">Editing:</h2>
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-majallab text-3xl">Formatting:</h2>
                            <p className="">From font choice to margins, our formatting <br></br> service makes sure your book is dressed<br></br> to impress.</p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-left">
                        <Image src={"/brand-img/process-img3.png"} width={700} height={200} className=" pb-10"></Image>
                        <div className="brand-process-content text-left">
                            <h2 className="font-majallab text-3xl">Proofreading:</h2>
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-majallab text-3xl">Typesetting & Layout:</h2>
                            <p className="">Expert typesetting that makes your book as<br></br> easy on the eyes as it is engaging<br></br> for the mind.</p>
                        </div>
                    </div>

                    <div className="relative" data-aos="fade-left">
                        <Image src={"/brand-img/process-img5.png"} width={700} height={200} className=" pb-10"></Image>
                        <div className="brand-process-content text-left mt-2">
                            <h2 className="font-majallab text-3xl">Cover Design:</h2>
                            <p className="">We create covers that speak to readers,<br></br> inviting them into the world you've created.</p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        <Image src={"/brand-img/process-img6.png"} width={700} height={200} className=" pb-10"></Image>
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-majallab text-3xl">Publishing:</h2>
