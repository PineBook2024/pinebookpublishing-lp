...
export default function BrandChooseUs() {
    ...
    return (
        <>
             <section className="brand-choose-us-section max-w-screen-xl ms-auto px-12 md:px-20 my-20 relative py-24 relative left-0 md:left-12">
                <div className="flex items-center flex-col md:flex-row">
                    ...
                    <div className="basis-1/2 md:ml-20">
                        <h2 className="text-white font-majallab text-6xl uppercase mt-10 md:mt-0">Why Choose Us</h2>
