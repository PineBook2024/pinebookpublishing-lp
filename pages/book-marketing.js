...
export default function BookMarketing() {
    ...
    return (
        <>
            <Head>
                <title>Expert Book Marketing Services  | Pine Book Publishing</title>
                <meta
                    name="description"
                    content="Promote your book with Pine Book Publishing’s book marketing services. Reach more readers, up your sales, and build a brand with marketing strategies."
                />
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                title="Expert Book Marketing Services to Boost Your Author Reach"
                desc="Make your book shine in front of the right readers with our professional book marketing services. We help authors promote their books through targeted campaigns, online visibility, and strategies that bring attention, reviews, and real reader engagement. Contact us today!"
            />
            <BrandBannerLogo />
            <div className="container mx-auto max-w-screen-xl overflow-hidden py-10 md:py-10">
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-10 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        Book Marketing Services That Drive Sales and Reader Interest</h2>
                        <p className="font-poppins text-xl	pt-3">
                            Book marketing isn’t just about spreading links — it’s about placing your book where readers are most likely to discover it. At Pine Book Publishing, we create campaigns that mix author brand promotion and targeted book marketing to help you stand out. Our team understands that every book is unique, so we design custom strategies that connect your story with the right audience.
                        </p>
                        <p className="font-poppins text-xl	pt-3">From social media buzz and email outreach to book reviews and Amazon book marketing, we handle it all. Our approach focuses on online book promotions that build trust and awareness while driving steady sales. Whether you’re a first-time author or already published, our marketing helps your book reach readers who will truly appreciate your work.</p>
                    </div>
                    <div className="basis-1/2 abt-pic text-center flex justify-center md:justify-center">
                        <Image src={"/brand-img/marketing.png"} width={470} height={300}
                            loading="lazy"
                            alt="about img"
            ...
            <section className="brand-process  mx-auto relative pt-10 text-center flex justify-center mb-12 overflow-hidden">
                <div className="max-w-screen-xl">
                    <div className="text-center mb-6">
                        ...
                        <h2 className="font-poppins text-3xl md:text-4xl text-black font-bold" data-aos="zoom-out-down">6-Step Process of Our <br></br>Book Marketing Service</h2>
                    </div>
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Audience Research:</h2>
                            <p className="para">We analyse reader demographics and<br></br> preferences to find your perfect<br></br> target audience for effective book promotions.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Marketing Strategy Plan:</h2>
                            <p className="para">We create a marketing roadmapcovering<br></br> digital ads, PR, and reader engagement <br></br>to meet your author goals.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Social Media Marketing for Books:</h2>
                            <p className="para">Our team designs and runs engaging<br></br> posts and promotions to build<br></br> author visibility and book awareness online.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Book Reviews & PR:</h2>
                            <p className="para">We connect your book with reviewers,<br></br> bloggers, and media outlets to gain<br></br> credibility and attract new readers.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Advertising & Outreach:</h2>
                            <p className="para">We manage ad campaigns on Amazon,<br></br> Facebook, and Google to boost discoverability<br></br> and steady book sales.</p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        <Image src={"/brand-img/process-img6.png"} width={700} height={200} className=" pb-10"></Image>
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Performance Tracking:</h2>
                            <p className="para">We monitor analytics and engagement <br></br>results, refining campaigns for consistent<br></br> audience growth and higher conversions.</p>
                        </div>
                    </div>
                </div>
