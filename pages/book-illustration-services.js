...
export default function BookMarketing() {
    ...
    return (
        <>
            <Head>
                <title>Top Book Illustration Services | Pine Book Publishing</title>
                <meta
                    name="description"
                    content="Get professional book illustration services that visually enhance your story. Expert illustrators for children’s, fiction, and fantasy books."
                />
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                title="Professional Book Illustration Services for Authors Worldwide"
                desc="At Pine Book Publishing, we offer professional book illustration services from book covers to character sketches that bring your stories to life through captivating visuals. From children’s tales to complex fiction, our skilled illustrators design artwork that connects with readers and complements your book’s style, genre, and emotional tone. Get in touch now!"
            />
            <BrandBannerLogo />
                ...
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-10 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <h2 className="font-poppins text-3xl md:text-3xl uppercase font-bold">
                            Book Illustration Services that Add Meaning to Every Page</h2>
                        <p className="font-poppins text-xl	pt-3">
                            Great illustrations don’t just decorate a story—they tell it. At Pine Book Publishing, our book illustration services help authors express emotions, themes, and messages that words alone can’t capture. Whether you’re writing for kids or adults, we create visuals that stay memorable, from book cover illustrations to character design, sketching and line art.
                        </p>
                        <p className="font-poppins text-xl	pt-3">Our illustrators use creative storytelling, artistic detailing, and digital design techniques to deliver illustrations that enhance your book’s appeal. We handle every genre, from fantasy and fiction to educational and motivational books, ensuring the artwork fits the tone and audience. With professional book design and creative illustration, your story will not just be read but experienced. Don’t wait, let our experts illustrate your book!
</p>
                    </div>
                    <div className="basis-1/2 abt-pic text-center flex justify-center md:justify-center">
                        <Image src={"/brand-img/book-illustration-service.png"} width={470} height={300}
                            loading="lazy"
                            alt="about img"
            ...
            <section className="brand-process  mx-auto relative pt-10 text-center flex justify-center mb-12 overflow-hidden">
                <div className="max-w-screen-xl">
                    <div className="text-center mb-6">
                        ...
                        <h2 className="font-poppins text-3xl md:text-4xl text-black font-bold" data-aos="zoom-out-down">6-Step Process of Our <br></br>Book Illustration Services</h2>
                    </div>
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Story Understanding:</h2>
                            <p className="para">We begin by reviewing your manuscript to<br></br> understand its tone, theme, and message<br></br> before planning the illustration style.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Concept Creation:</h2>
                            <p className="para">Our creative team develops concepts and<br></br> layouts that match your book’s vision<br></br> and deliver the perfect emotional impact.
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Sketch Development:</h2>
                            <p className="para">Initial sketches are created for all major<br></br> scenes, letting you preview the composition<br></br> and share early feedback freely.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Coloring & Detailing:</h2>
                            <p className="para">Once sketches are approved, our artists<br></br> add colors, shades, and detailed<br></br>textures to give your visuals depth and realism.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Review & Revisions:</h2>
                            <p className="para">You receive draft illustrations for review.<br></br> We fine-tune the visuals until they perfectly<br></br> fit your story and expectations.
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            ...
                            <p className="para">We deliver polished, high-quality illustrations<br></br> in your preferred format, ready for print<br></br> or digital publishing platforms.</p>
                        </div>
                    </div>
                </div>
