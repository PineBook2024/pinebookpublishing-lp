                ...
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-10 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        ...
                        <p className="font-poppins text-xl	pt-3">
                            If you have finished your manuscript and are tired of looking at the screen for many hours, struggling to bring your manuscript in a professional format that meets industry standards, hiring a professional book formatting company is the only option you should choose. We at <Link href={"https://pinebookpublishing.com/"} target="_blank" className="font-bold hover:text-blue-500">Pine Book Publishing</Link> are your trusted book formatting partner. With intense familiarity with publishing industry standards, we offer you comprehensive book formatting solutions for various popular publishing platforms.
                        </p>
