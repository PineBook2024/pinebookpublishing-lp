...
const notFound = () => {
    return (
        <div>
            ...
            <header id="navbar" className="header-404 bg-[#0d0f38] left-0 flex justify-between items-center p-4 z-10 relative">
            ...
            <section className="sec404 overflow-hidden block">
            ...
            <div className="copyright-sec bg-black">
                <div className="container text-center mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                    <p className="text-white w-full md:text-center text-sm sm:text-left">
                        ...
                        Powered by <span className="powered-by-text"><Link href="https://www.pinebookpublishing.com/" target="_blank">Pine Book Publishing Inc.</Link></span>
                    </p>
                </div>
            </div>
