...
export default function BookMarketing() {
    ...
    return (
        <>
            <Head>
                <title>Expert Book Translation Services for Authors
</title>
                <meta
                    name="description"
                    content="Professional book translation services that preserve your story’s essence. Reach global readers with accurate, culturally adapted translations."
                />
            ...
            <BrandNavbar />
            <BrandPrimaryHeader
                title="Best Book Translation Services for Global Authors"
                desc="Reach worldwide readers with our professional book translation services. We translate your book into multiple languages while preserving its original tone, emotions, and meaning—making it relatable to audiences from different cultures and regions. Let’s translate for you!"
            />
            <BrandBannerLogo />
                ...
                <div className="flex justify-center items-center flex-col md:flex-row lg:flex-row px-10 md:px-0 py-10 md:py-0">
                    <div className="basis-1/2 abt-txt m1-h p1 aos-init aos-animate" data-aos="fade-right" data-aos-duration="1000">
                        <h2 className="font-poppins text-3xl md:text-3xl uppercase font-bold">
                           Book Translation Services That Keep Your Story’s Heart Alive
</h2>
                        <p className="font-poppins text-xl	pt-3">
                            At Pine Book Publishing, we believe every story deserves to travel beyond borders. Our book translation services help authors expand globally without losing their voice or writing style. From fiction to memoirs, we ensure the translated version feels native and natural.
                        </p>
                        <p className="font-poppins text-xl	pt-3">Our expert translators specialize in literary translation, focusing on context, tone, and cultural relevance. Whether your goal is global publishing or regional reach, we adapt your words accurately while keeping emotional depth intact. Through our multilingual translation services, your story can now connect with readers worldwide—without losing its originality. Write your books freely and leave it to us for flawless yet meaningful translation!
</p>
                    </div>
                    <div className="basis-1/2 abt-pic text-center flex justify-center md:justify-center">
                        <Image src={"/brand-img/translation.avif"} width={470} height={300}
                            loading="lazy"
                            alt="about img"
            ...
            <section className="brand-process  mx-auto relative pt-10 text-center flex justify-center mb-12 overflow-hidden">
                <div className="max-w-screen-xl">
                    <div className="text-center mb-6">
                        ...
                        <h2 className="font-poppins text-3xl md:text-4xl text-black font-bold" data-aos="zoom-out-down">6-Step Process of Our <br></br>Book Translation Services
</h2>
                    </div>
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            ...
                            <p className="para">We start by studying your manuscript<br></br> to understand tone, writing style, and<br></br> message before translation begins.
                            </p>
                        </div>
                    </div>
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Language Pair Selection:</h2>
                            <p className="para">Based on your target audience, we assign<br></br> certified translators fluent in both<br></br> source and destination languages.
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            <h2 className="font-poppins text-2xl">Cultural Adaptation</h2>
                            <p className="para">Our professional translators localize phrases,<br></br> idioms, and references to fit the cultural<br></br> tone of your target readers.
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            <h2 className="font-poppins text-2xl">Quality Translation:</h2>
                            <p className="para">Using linguistic accuracy and creative<br></br> flow, we deliver a translated draft<br></br> that retains your book’s true voice.
                    ...
                    <div className="relative" data-aos="fade-left">
                        ...
                        <div className="brand-process-content text-left">
                            ...
                            <p className="para">Our bilingual editors refine grammar, rhythm,<br></br> and clarity—ensuring your translated<br></br> text reads like a native piece.
                    ...
                    <div className="relative" data-aos="fade-right">
                        ...
                        <div className="brand-process-content-right text-right">
                            ...
                            <p className="para">We deliver your manuscript in the requested<br></br> format, ready for global publishing or<br></br> self-publishing platforms.
