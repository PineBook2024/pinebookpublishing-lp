...
export default function Home() {
  ...
  const filteredBooks = bookss.filter(book => book.category === activeCategory);
  ...
  const steps = [
    ...
    { title: "Cover Adjustment", imgTop: "/images/p-img-top.webp", imgBottom: "/images/p-img-bottom.webp", img: "/images/p-img.webp", img1: "/images/p-img1.webp", icon: "/images/Cover Design.png" },
  ...
  const marketingPackages = [
    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: ["Retail Bookstore Placement", "Global Distribution Growth"],
        },
        {
          heading: "Long-Term Support",
    ...
    },
    {
      ...
      sections: [
        {
          heading: "Elite Visibility",
          items: ["Premium International Book Fair Representation", "Multi-Event Literary Exhibition Placement"],
        },
        {
          heading: "Media Exposure",
        ...
        {
          heading: "Sales Acceleration",
          items: ["Comprehensive Amazon Best Seller Campaigns", "Expanded Influencer Marketing Network", "Reader Outreach Campaigns"],
        },
        {
          heading: "Brand Expansion",
          items: ["Merchandise Creation & Development", "Expanded Retail Placement Opportunities", "Enhanced Global Distribution Strategy"],
        },
        {
          heading: "Long-Term Support",
          items: ["Dedicated Marketing Team", "Quarterly Performance Reviews", "36 Months Author Branding Support"],
        },
        {
          heading: "Guarantees",
          items: ["No Royalties Share", "100% Ownership Rights", "100% Satisfaction"],
            ...
            <div className="container mx-auto position-relative">
              ...
              <div className="bnd-slider offer-logo-marquee flex py-7">
                <div className="offer-logo-track">
                  {[0, 1, 2].map((group) => (
                    <div key={`offer-logo-set-${group}`} className="offer-logo-set">
                      {[
                        ...
                        <a key={`offer-logo-${group}-${idx}`} href="#" className="offer-logo-item">
                          <Image
                            alt="LOGO"
                            src={logo.src}
                            width={logo.width}
                  ...
                  {marketingPackages.map((item) => (
                    <div className="single-packages marketing-package-card relative" key={item.title}>
                      ...
                      <div className="single-packages-content marketing-packages-content mb-5 px-10">
                        ...
                        <p className="marketing-package-desc">{item.description}</p>
                        {item.sections.map((section) => (
                          <div key={section.heading} className="marketing-package-section">
                            <div className="flex gap-2 mb-5 items-center text-xl">
                              {section.heading}
                            </div>
                            {section.items.map((feature) => (
                              <div className="flex gap-2 mb-5 items-center" key={feature}>
                                <Image src={"/images/check-mark.png"} className="icon" width={13} height={13}></Image>
                                {feature}
                              </div>
                            ))}
                      ...
                      <div className="text-center">
                        <button className="package-get-started-btn text-md mt-7" onClick={() => openModal(item.title)}>
                          GET A QUOTE
                        </button>
                      </div>
                      <div className="single-packages-footer flex  w-100 justify-center">
