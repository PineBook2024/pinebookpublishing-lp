          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6 bg-white border rounded-xl">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div>
                ...
                <select name="payment_status" defaultValue="pending" className="w-full px-3 py-2 border rounded-lg">
              ...
              <div>
                ...
                <select name="order_status" defaultValue="pending" className="w-full px-3 py-2 border rounded-lg">
                  <option value="pending">pending</option>
