...
export const Icons = {
  ...
  Truck: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 17h4V5H2v12h3"/><path d="M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5v8h1"/><circle cx="7.5" cy="17.5" r="2.5"/><circle cx="17.5" cy="17.5" r="2.5"/></svg>
  ),
  Heart: () => (
...
export const sidebarItems = [
  ...
  { id: "products", label: "Products", icon: "Products", href: "/admin/products" },
  ...
  { id: "featured-books", label: "Featured Books", icon: "BookOpen", href: "/admin/featured-books" },
  { id: "marketing-requests", label: "Marketing Requests", icon: "Megaphone", href: "/admin/marketing-requests" },
  ...
  { id: "wishlists", label: "Wishlists", icon: "Heart", href: "/admin/wishlists" },
  { id: "withdrawals", label: "Withdrawals", icon: "DollarSign", href: "/admin/withdrawals" },
  { id: "aproovals", label: "Approvals", icon: "CheckCircle", href: "/admin/aproovals" },
  { id: "permissions", label: "Permissions", icon: "Shield", href: "/admin/permissions" },
];
...
export default function Sidebar({ activeTab, onTabChange, sidebarOpen, onToggle }) {
  return (
    <motion.aside
    ...
    >
      ...
      <div className="flex items-center gap-3 p-6 border-b border-white/10">
        <motion.div
          ...
          className="flex items-center justify-center flex-shrink-0 w-10 h-10 shadow-lg bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl"
        >
